...
4. Следуй гайдлайнам karpathy и ponytail: root-cause, а не band-aid; хирургические изменения; кратчайший рабочий diff; переиспользуй существующее; без over-engineering.
5. В конце ответа ОБЯЗАТЕЛЬНО блоки в точных заголовках ниже (для оркестратора).
